"""
Django settings for reviewer review.
...
# Build paths inside the review like this: BASE_DIR / 'subdir'.
...
SECRET_KEY = 'django-insecure-fd@jt&^*ubityyn$_e!*jbeiwxgdymwz3v%ks&7yz3b=36mlaj'
